...
<div id="title-carbon" class="heading-title">
  <div class="row">
    <div class="columns small-12 large-8 large-centered center">
      <h1><img src="../img/carbon-logo.png" style="max-width:300px;"></h1>
    </div>
  </div>
</div>

<section class="contents product-page" id="carbon-page">
  <div class="row">
    <div class="columns small-12 large-8 large-centered center">
      <h3 class="sub-tag">Everyone can be a chef - Make cooking fun, simple, and effortless </h3>
  ...
  <div class="spacer"></div>
   ...
   <div class="row">
    <div class="columns small-12 large-4 medium-4 medium-offset-2 center results">
      <h1><img src="../img/bt.svg"></h1>
      <p>Bluetooth Technology</p>
    </div>
    <div class="columns small-12 large-4 medium-4 center results end">
      <h1><img src="../img/chips.svg"></h1>
