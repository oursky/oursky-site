...
<div class="heading-title">
  <div class="row">
    <div class="columns small-12 large-9 medium-9 large-centered medium-centered center">
      ...
      <p class="paragraph">
        We're like the CTO of your startups, and are the most <br>
        experienced in town to execute it well.
      </p>
    </div>
  </div>
</div>
    ...
    <div class="swiper-wrapper">
      <div class="swiper-slide">
        <div class="plan-block">
          ...
          <p class="center"><a href="${bf.util.site_path_helper('enquiry/prototype')}/?ref=prototype" class="btn">Get Started</a></p>
        </div>
      </div>
  ...
  <div class="row faq-block">
    <div class="columns large-6 medium-6">
      <p class="bold">How shall I start if I just got an idea?<br>
        <span class="normal annotate">Talk with our consultant and we will help visualize your idea into a wireframe. The wireframe can then be used to make a mockup design and further develop into an MVP app.</span>
      </p>
    </div>
    <div class="columns large-6 medium-6">
      <p class="bold">I have a prototype / design already, What's next?<br>
        <span class="normal annotate">That's great! We can help polish the design a bit and refine the scope to launch an MVP within 3 months.</span>
      </p>
    </div>
  </div>
  <div class="row faq-block">
    <div class="columns large-6 medium-6">
      <p class="bold">What technologies are your team familiar with?<br>
        <span class="normal annotate">Our team are most familiar with native iOS and Android coding, Angular / React-Flux on web frontend, Python / Go and Ruby on Rails on backend, and Docker for deployment over Amazon Web Services or Softlayer. We've also got experience on various Content Management System and Cloud Deployment System, send us an enquiry for details.</span>
      </p>
    </div>
    <div class="columns large-6 medium-6">
      <p class="bold">Can you work with our internal technical team?<br>
        <span class="normal annotate">Sure, we can share the github code repository and issue trackers with your technical team; Or define the API and work together on backend / frontend separately.</span>
      </p>
    </div>
  </div>
  <div class="row faq-block">
    <div class="columns large-6 medium-6">
      <p class="bold">Why develop on single platform first?<br>
        <span class="normal annotate">Most apps make changes after launching for product market fits / business model / user feedback; So focus on single platform (Web / iOS / Android) first, and port it to other platforms once the app is more mature, is cheaper.</span>
      </p>
    </div>
    <div class="columns large-6 medium-6">
      <p class="bold">What is Oursky tech process?<br>
        <span class="normal annotate">We use github with travis for code repo and continuous integrations; Every commit / pull request is peer reviewed to ensure quality, and our Project Managers hold daily standup with bi-weekly sprint. Our QA engineers design smoke test and full test suites for regular testing too.</span>
      </p>
    </div>
  </div>
  <div class="row faq-block">
    <div class="columns large-6 medium-6">
      <p class="bold">How can I proceed if I have an existing app and need help on enhancements?<br>
        <span class="normal annotate">We can start with a small project on studying your existing code base and define the scope of future work with 1 iteration.</span>
      </p>
    </div>
    <div class="columns large-6 medium-6">
      <p class="bold">Do you have any post-launch services for my product?<br>
        <span class="normal annotate">We can arrange a retainer contract for maintenance and ongoing updates for your product. We are happy to offer other services like scalability, optimisation ,hiring advice and user-testing as well. </span>
      </p>
    </div>
  </div>
</section>
