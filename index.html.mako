<%inherit file="_templates/site.mako" />
    ...
    <section id="tagline" class="hero-img">
      <div class="row full-height">
        <div class="columns large-12 full-height">
        	<div class="aligner hero-img-icon">
	          <h1 class="tagline">We build better Apps</h1>
	      	</div>
    ...
    <div class="row">
	    <div class="columns large-12 center">
	    	...
	    	<a href="#">VIPER – iOS app architecture beyond MVC (Mega-ViewController)</a>
	    </div>
	</div>
