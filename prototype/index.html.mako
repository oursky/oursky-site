  ...
  <div class="v-center full-width">
    <div class="row">
      <div class="columns small-12 medium-6 large-6">
        <h2>Release the full potential of your idea and turn it into a real thing</h2>
      </div>
    </div>
   </div>
             ...
             <div class="columns small-12 medium-12">
              ...
              <h3 class="sub-tag">Next steps?</h3>
                ...
                <p>We can provide retainer services for:
                  <ul>
                    <li>Enhancement of the prototype.</li>
                    <li>Development of the production app and launch it in App Store.</li>
                    <li>Transition to help turn the development over to an internal team or 3rd party.</li>
                  </ul>
                </p>
