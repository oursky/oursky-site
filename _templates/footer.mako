...
<footer>
      ...
      <div class="columns large-5">
        <ul class="footer-sitemap">
          ...
          <li>
            Products
            <ul>
              <li><a href="#">PandaForm</a></li>
              <li><a href="#">Retain.cc</a></li>
              <li><a href="#">FileSqaure</a></li>
              <li><a href="#">GifCam</a></li>
  ...
  <div class="row">
    <div class="footnote">
    <span class="footnote floatLeft">&copy; 2015 OURSKY. All rights reserved.</span>
      <span class="footnote floatRight all-caps">Develop with passion</span>
    </div>
  </div>
