<header>
      ...
      <div class="row">
        ...
        <div class="large-4 columns alignRight">
          <a href="#" class="btn-header btn">Start your project</a>
...
<nav id="main-nav">
	<div class="row">
		...
		<div class="columns large-2">
			<a href="#" class="nav-close floatRight nav-toggle"><img src="img/close.svg"></a>
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="columns large-5 end">
			<div class="nav-block">
				...
				<a class="nav-work-block" style="background-image:url('img/nav-work-1.png')">
					Jamn Player
				</a>
				<a class="nav-work-block" style="background-image:url('img/nav-work-2.png')">
					Bindle
				</a>
				<a href="#" class="nav-cta btn ">Start your project</a>
			</div>
		</div>
