<header class="header-white">
  ...
  <div class="row">
    <div class="floatLeft">
      <div class="header-logo" >
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="3 215.1 806 165" enable-background="new 3 215.1 806 165" xml:space="preserve">
          <a xlink:href="${bf.util.site_path_helper('index.html')}" target="_parent">
    ...
    <div class="floatRight">
      <a href="${bf.util.site_path_helper('enquiry/general')}" class="hide btn-header btn visible-for-medium-up">Start your project</a>
